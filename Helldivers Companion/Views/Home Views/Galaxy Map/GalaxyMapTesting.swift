...
struct GalaxyMapTesting: View {
    ...
    let planetPositions: [PlanetPosition] = [
        ...
        PlanetPosition(name: "Super Earth", xMultiplier: 0.5, yMultiplier: 0.5),
        PlanetPosition(name: "Veld", xMultiplier: 0.7159982543364164, yMultiplier: 0.46782872429388467),
        PlanetPosition(name: "Angel's Venture", xMultiplier: 0.716856871584672, yMultiplier: 0.42555237069407864),
        PlanetPosition(name: "Heeth", xMultiplier: 0.6908253813690813, yMultiplier: 0.36872425772414646),
        PlanetPosition(name: "Fort Union", xMultiplier: 0.6321935205923247, yMultiplier: 0.3977322099909968),
        PlanetPosition(name: "Azterra", xMultiplier: 0.609510133255280, yMultiplier: 0.36022534799340045),
        PlanetPosition(name: "Cirrus", xMultiplier: 0.6565503532776144, yMultiplier: 0.3711073466410754),
        PlanetPosition(name: "Terrek", xMultiplier: 0.6315762443635128, yMultiplier: 0.3275361116406011),
        PlanetPosition(name: "Clasa", xMultiplier: 0.46699755702922585, yMultiplier: 0.18673292165322927),
        PlanetPosition(name: "Maia", xMultiplier: 0.042455869058871124, yMultiplier: 0.5176247891610795),
        PlanetPosition(name: "Eukoria", xMultiplier: 0.5931632262870994, yMultiplier: 0.6380742359290226),
        PlanetPosition(name: "Regnus", xMultiplier: 0.6221908632588867, yMultiplier: 0.6569017489266386),
        PlanetPosition(name: "Mog", xMultiplier: 0.6424682184954074, yMultiplier: 0.6730250630791889),
        PlanetPosition(name: "Adhara", xMultiplier: 0.6803472769822542, yMultiplier: 0.6988017082902191),
        PlanetPosition(name: "Acubens Prime", xMultiplier: 0.6940770390048726, yMultiplier: 0.668110559839513),
        PlanetPosition(name: "Rasp", xMultiplier: 0.6939893170811958, yMultiplier: 0.6278449653863285),
        PlanetPosition(name: "Kharst", xMultiplier: 0.6327575443707785, yMultiplier: 0.6031943552332578),
        PlanetPosition(name: "Bashyr", xMultiplier: 0.6600680610868331, yMultiplier: 0.6275850703710993),
        PlanetPosition(name: "Alairt III", xMultiplier: 0.5576724926524862, yMultiplier: 0.7901660588368167),
        PlanetPosition(name: "Valmox", xMultiplier: 0.5924603562713632, yMultiplier: 0.6861257731329146),
        PlanetPosition(name: "Genesis Prime", xMultiplier: 0.4624916090476724, yMultiplier: 0.7177131648237158),
        PlanetPosition(name: "Parsh", xMultiplier: 0.48030658522760233, yMultiplier: 0.6613171436163755),
        PlanetPosition(name: "Kerth Secundus", xMultiplier: 0.5236499688678392, yMultiplier: 0.6652887565302629),
        PlanetPosition(name: "Grafmere", xMultiplier: 0.5317478296266223, yMultiplier: 0.6977269212539294),
        PlanetPosition(name: "Ain-5", xMultiplier: 0.6068873001977115, yMultiplier: 0.7389829740080184),
        PlanetPosition(name: "Alamak VII", xMultiplier: 0.5301789919777963, yMultiplier: 0.7587967530605242),
        PlanetPosition(name: "New Stockholm", xMultiplier: 0.5734192357872637, yMultiplier: 0.7477415395345797),
        PlanetPosition(name: "Iro", xMultiplier: 0.5757457350094041, yMultiplier: 0.7127509854407853),
        PlanetPosition(name: "Oasis", xMultiplier: 0.5023260166612308, yMultiplier: 0.7154711478964171),
        PlanetPosition(name: "Gemma", xMultiplier: 0.7731726797018019, yMultiplier: 0.6336912346602118),
        PlanetPosition(name: "Grand Errant", xMultiplier: 0.8375992779152016, yMultiplier: 0.6192076811010954),
        PlanetPosition(name: "Pollux 31", xMultiplier: 0.8750844138357307, yMultiplier: 0.7323915900370993),
        PlanetPosition(name: "Overgoe Prime", xMultiplier: 0.9489768763805315, yMultiplier: 0.40585299527850655),
        PlanetPosition(name: "Providence", xMultiplier: 0.5149347694141551, yMultiplier: 0.3875682014794003),
        PlanetPosition(name: "Klen Dahth II", xMultiplier: 0.5258927329042502, yMultiplier: 0.44981368342159556),
        PlanetPosition(name: "Pilen V", xMultiplier: 0.5769586702891163, yMultiplier: 0.4809376910878071),
        PlanetPosition(name: "Valgaard", xMultiplier: 0.5825016962137285, yMultiplier: 0.29845923453784295),
        PlanetPosition(name: "New Haven", xMultiplier: 0.5496336959163884, yMultiplier: 0.47340321244730593),
        PlanetPosition(name: "Acrab XI", xMultiplier: 0.7478506064084655, yMultiplier: 0.604033184386196),
        PlanetPosition(name: "Acrux IX", xMultiplier: 0.7785694898352888, yMultiplier: 0.5949498206852407),
        PlanetPosition(name: "Bellatrix", xMultiplier: 0.34984443290845246, yMultiplier: 0.7250544083961437),
        PlanetPosition(name: "Alderidge Cove", xMultiplier: 0.34748591232322085, yMultiplier: 0.6933457791980411),
        PlanetPosition(name: "Malevelon Creek", xMultiplier: 0.08410897382831509, yMultiplier: 0.5504921958009737),
        PlanetPosition(name: "Durgen", xMultiplier: 0.049140630733922774, yMultiplier: 0.5820841983319105),
        PlanetPosition(name: "Polaris Prime", xMultiplier: 0.8726326351128662, yMultiplier: 0.6662302032337033),
        PlanetPosition(name: "Pherkad Secundus", xMultiplier: 0.9246883671797628, yMultiplier: 0.6433570322779485),
        PlanetPosition(name: "Primordia", xMultiplier: 0.5461321474538012, yMultiplier: 0.37531451452636344),
        PlanetPosition(name: "Ratch", xMultiplier: 0.5255754120733388, yMultiplier: 0.2909894470364045),
        PlanetPosition(name: "Krakabos", xMultiplier: 0.5201948627982851, yMultiplier: 0.34084922803828005),
        PlanetPosition(name: "Iridica", xMultiplier: 0.5550310110709022, yMultiplier: 0.33388486178309534),
        PlanetPosition(name: "Mintoria", xMultiplier: 0.4742289309552572, yMultiplier: 0.08538525975779357),
        PlanetPosition(name: "Minchir", xMultiplier: 0.5415521038005128, yMultiplier: 0.09003636854339397),
        PlanetPosition(name: "Zzaniah Prime", xMultiplier: 0.40291211601390947, yMultiplier: 0.044209084680176175),
        PlanetPosition(name: "Zosma", xMultiplier: 0.3239112840305582, yMultiplier: 0.06702604329306772),
        PlanetPosition(name: "Zefia", xMultiplier: 0.4773767852096095, yMultiplier: 0.14486722960701082),
        PlanetPosition(name: "Yed Prior", xMultiplier: 0.4341651186403509, yMultiplier: 0.1519406042849129),
        PlanetPosition(name: "Meissa", xMultiplier: 0.2196648052559523, yMultiplier: 0.25685958209683746),
        PlanetPosition(name: "Wezen", xMultiplier: 0.07460478230276553, yMultiplier: 0.3279779436278944),
        PlanetPosition(name: "Vega Bay", xMultiplier: 0.11030948318897056, yMultiplier: 0.255142410091064),
        PlanetPosition(name: "X-45", xMultiplier: 0.16123724618806737, yMultiplier: 0.2070540328249113),
        PlanetPosition(name: "Wasat", xMultiplier: 0.17726245407641525, yMultiplier: 0.27872489074580487),
        PlanetPosition(name: "Vindemitarix Prime", xMultiplier: 0.22312748616769426, yMultiplier: 0.1212479457143628),
        PlanetPosition(name: "Merga IV", xMultiplier: 0.3364416594627106, yMultiplier: 0.13677942250231065),
        PlanetPosition(name: "Cyberstan", xMultiplier: 0.28217194139992635, yMultiplier: 0.15999592053953823),
        PlanetPosition(name: "Mekbuda", xMultiplier: 0.23639421575825936, yMultiplier: 0.18259686182545137),
        PlanetPosition(name: "Aurora Bay", xMultiplier: 0.2787754500632348, yMultiplier: 0.20883035025392876),
        PlanetPosition(name: "Merak", xMultiplier: 0.3248534155378594, yMultiplier: 0.18564327679754544)
    ]
