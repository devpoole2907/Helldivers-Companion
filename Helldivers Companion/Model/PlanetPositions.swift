...
let sectorLookup: [Int64: Sector] = [
    0: Sector(name: "Sol", index: 0),
    1: Sector(name: "Altus", index: 1),
    2: Sector(name: "Barnard", index: 2),
    3: Sector(name: "Cancri", index: 3),
    4: Sector(name: "Gothmar", index: 4),
    5: Sector(name: "Cantolus", index: 5),
    6: Sector(name: "Idun", index: 6),
    7: Sector(name: "Kelvin", index: 7),
    8: Sector(name: "Iptus", index: 8),
    9: Sector(name: "Celeste", index: 9),
    10: Sector(name: "Korpus", index: 10),
    11: Sector(name: "Gallux", index: 11),
    12: Sector(name: "Morgon", index: 12),
    13: Sector(name: "Rictus", index: 13),
    14: Sector(name: "Saleria", index: 14),
    15: Sector(name: "Meridian", index: 15),
    16: Sector(name: "Theseus", index: 16),
    17: Sector(name: "Sagan", index: 17),
    18: Sector(name: "Marspira", index: 18),
    19: Sector(name: "Talus", index: 19),
    20: Sector(name: "Orion", index: 20),
    21: Sector(name: "Draco", index: 21),
    22: Sector(name: "Orion", index: 22),
    23: Sector(name: "Borgus", index: 23),
    24: Sector(name: "Farsight", index: 24),
    25: Sector(name: "Ferris", index: 25),
    26: Sector(name: "Rigel", index: 26),
    27: Sector(name: "Akira", index: 27),
    28: Sector(name: "Guang", index: 28),
    29: Sector(name: "Tarragon", index: 29),
    30: Sector(name: "Alstrad", index: 30),
    31: Sector(name: "Xzar", index: 31),
    32: Sector(name: "Nanos", index: 32),
    33: Sector(name: "Xzar", index: 33),
    34: Sector(name: "Lacaille", index: 34),
    35: Sector(name: "Tanis", index: 35),
    36: Sector(name: "Arturion", index: 36),
    37: Sector(name: "L'estrade", index: 37),
    38: Sector(name: "Umlaut", index: 38),
    39: Sector(name: "Jin Xi", index: 39),
    40: Sector(name: "Farsight", index: 40),
    41: Sector(name: "Leo", index: 41),
    42: Sector(name: "Rigel", index: 42),
    43: Sector(name: "Omega", index: 43),
    44: Sector(name: "Xi Tauri", index: 44),
    45: Sector(name: "Quintus", index: 45),
    46: Sector(name: "Severin", index: 46)
]
